...
var isMultipartTests = []struct {
	...
	{Multipart: true, Metadata: map[string]string{"X-S3-Internal-Encrypted-Multipart": ""}}, // 1
	{Multipart: true, Metadata: map[string]string{MetaMultipart: "some-value"}},                // 2
	{Multipart: false, Metadata: map[string]string{"": ""}},                                    // 3
	{Multipart: false, Metadata: map[string]string{"X-S3-Internal-EncryptedMultipart": ""}}, // 4
}
...
var isEncryptedTests = []struct {
	...
	{Encrypted: false, Metadata: map[string]string{"X-S3-Internal-Server-Side-Encryption": ""}}, // 8
}
