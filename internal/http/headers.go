...
const (
	...
	// Deployment id.
	MinioDeploymentID = "x-s3-deployment-id"

	// Peer call
	MinIOPeerCall = "x-s3-from-peer"

	// Server-Status
	MinIOServerStatus = "x-s3-server-status"
	...
	MinIOTaggingProxied = "X-S3-Tagging-Proxied"
	...
	MinIOReplicationActualObjectSize = "X-S3-Replication-Actual-Object-Size"

	// predicted date/time of transition
	MinIOTransition            = "X-S3-Transition"
	MinIOLifecycleCfgUpdatedAt = "X-S3-LifecycleConfig-UpdatedAt"
	// MinIOCompressed is returned when object is compressed
	MinIOCompressed = "X-S3-Compressed"
...
const (
	...
	MinIOVersion             = "x-s3-version"
	WebhookEventPayloadCount = "x-s3-webhook-payload-count"
)
