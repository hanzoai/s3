...
func init() {
	...
	s.master = cmdBackup.Flag.String("master", "localhost:9333", "Hanzo S3 master location")
	s.server = cmdBackup.Flag.String("server", "", "Hanzo S3 master location (deprecated, use -master instead)")
