...
func init() {
	...
	d.master = cmdDownload.Flag.String("master", "localhost:9333", "Hanzo S3 master location")
	d.server = cmdDownload.Flag.String("server", "", "Hanzo S3 master location (deprecated, use -master instead)")
...
var cmdDownload = &Command{
  ...
  What's more, if you use "s3 upload -maxMB=..." option to upload a big file divided into chunks, you can
