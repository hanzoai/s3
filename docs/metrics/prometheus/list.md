...
| Name                                              | Description                                    |
|:--------------------------------------------------|:-----------------------------------------------|
| `s3_cluster_nodes_offline_total`               | Total number of MinIO nodes offline.           |
| `s3_cluster_nodes_online_total`                | Total number of MinIO nodes online.            |
...
| Name                          | Description                            |
|:------------------------------|:---------------------------------------|
| `s3_software_commit_info`  | Git commit hash for the MinIO release. |
| `s3_software_version_info` | MinIO Release tag for the server.      |
...
| Name                                       | Description                                                                                                     |
|:-------------------------------------------|:----------------------------------------------------------------------------------------------------------------|
| `s3_node_file_descriptor_limit_total`   | Limit on total number of open file descriptors for the MinIO Server process.                                    |
| `s3_node_file_descriptor_open_total`    | Total number of open file descriptors by the MinIO Server process.                                              |
...
| `s3_node_process_starttime_seconds`     | Start time for MinIO process per node, time in seconds since Unix epoc.                                         |
| `s3_node_process_uptime_seconds`        | Uptime for MinIO process per node in seconds.                                                                   |
