...
echo "🔥 Hanzo RDMA Complete Optimization Test"
...
VOLUME_SERVER="http://hanzo-volume:8080"
...
main() {
    ...
    echo "2. Test with s3 mount: docker compose -f docker-compose.mount-rdma.yml logs hanzo-mount"
