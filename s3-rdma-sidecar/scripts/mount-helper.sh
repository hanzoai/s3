...
FILER_ADDR=${FILER_ADDR:-"hanzo-filer:8888"}
RDMA_SIDECAR_ADDR=${RDMA_SIDECAR_ADDR:-"rdma-sidecar:8081"}
MOUNT_POINT=${MOUNT_POINT:-"/mnt/hanzo"}
...
echo -e "${BLUE}🚀 Hanzo RDMA Mount Helper${NC}"
echo "================================"
...
# Build mount command
MOUNT_CMD="/usr/local/bin/s3 mount"
...
echo -e "${BLUE}🗂️  Starting Hanzo mount...${NC}"
