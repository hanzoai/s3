...
func TestCommonParities(t *testing.T) {
	...
	fi1 := FileInfo{
		...
		Metadata: map[string]string{
			"content-type": "application/octet-stream", "etag": "f205307ef9f50594c4b86d9c246bee86", "x-s3-internal-erasure-upgraded": "5->6", "x-s3-internal-inline-data": "true",
		},
	...
	fi2 := FileInfo{
		...
		Metadata:         map[string]string{"content-type": "application/octet-stream", "etag": "f205307ef9f50594c4b86d9c246bee86", "x-s3-internal-inline-data": "true"},
		Parts: []ObjectPartInfo{
			{
				ETag:       "",
				Number:     1,
