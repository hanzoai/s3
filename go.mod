...
// Hanzo S3 is a fork of SeaweedFS (Apache-2.0). The internal Go packages keep
// their original import path github.com/seaweedfs/seaweedfs/... so the fork
// tracks upstream with zero source churn; this self-replace resolves them to
// this module's tree. Only user-facing strings and the binary name are rebranded.
