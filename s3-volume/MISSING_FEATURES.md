...
- **Files**: `s3/storage/needle/needle_read.go`, `s3/server/volume_server_handlers_read.go`
- **Effort**: Medium
...
- **Files**: `s3/server/volume_server_handlers_read.go:138-250`
- **Effort**: Medium
...
- **Files**: `s3/security/tls.go`, `s3/command/volume.go`
...
- **Files**: `s3/server/volume_grpc_admin.go`
- **Effort**: Low
...
- **Files**: `s3/server/volume_server_handlers_write.go`
- **Effort**: Low
...
- **Files**: `s3/server/volume_server_handlers_write.go`, `volume_server_handlers_admin.go`
- **Effort**: Low
...
- **Files**: `s3/storage/needle/needle.go:CreateNeedleFromRequest`
- **Effort**: Medium
...
- **Files**: `s3/images/orientation.go`
...
- **Files**: `s3/storage/needle/volume_ttl.go`, `s3/storage/volume_read.go`
- **Effort**: Low
...
- **Files**: `s3/server/volume_server.go`
- **Effort**: Low
...
- **Files**: `s3/server/volume_server_handlers_read.go`
...
- **Files**: `s3/storage/needle_map_leveldb.go`
...
- **Files**: `s3/storage/needle/async_request.go`
- **Effort**: Medium
...
- **Files**: `s3/storage/volume_checking.go`, `s3/storage/idx/check.go`
- **Effort**: Medium
...
- **Files**: `s3/storage/volume_backup.go`
- **Effort**: Medium
...
- **Files**: `s3/storage/volume_info/volume_info.go`
- **Effort**: Low
...
- **Files**: `s3/storage/disk_location.go`
- **Effort**: Medium
...
- **Files**: `s3/storage/needle_map/compact_map.go`
- **Effort**: Medium
...
- **Files**: `s3/server/volume_grpc_tier_upload.go`, `volume_grpc_tier_download.go`
- **Effort**: High

### P4.2 gRPC: Query (S3 Select)
- **Go**: JSON/CSV query over needle data (S3 Select compatible)
- **Rust**: Stub returning error
- **Files**: `s3/server/volume_grpc_query.go`
- **Effort**: High
