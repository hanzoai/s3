...
//!
//! Mirrors the Go Hanzo volume server metrics.
...
lazy_static::lazy_static! {
    ...
    pub static ref REQUEST_COUNTER: IntCounterVec = IntCounterVec::new(
        Opts::new("Hanzo_volumeServer_request_total", "Volume server requests"),
        &["type", "code"],
    ...
    pub static ref REQUEST_DURATION: HistogramVec = HistogramVec::new(
        HistogramOpts::new(
            "Hanzo_volumeServer_request_seconds",
    ...
    pub static ref HANDLER_COUNTER: IntCounterVec = IntCounterVec::new(
        Opts::new("Hanzo_volumeServer_handler_total", "Volume server handler counters"),
        &["type"],
    ).expect("metric can be created");
    ...
    pub static ref VACUUMING_COMPACT_COUNTER: IntCounterVec = IntCounterVec::new(
        Opts::new("Hanzo_volumeServer_vacuuming_compact_count", "Counter of volume vacuuming Compact counter"),
        &["success"],
    ).expect("metric can be created");
    ...
    pub static ref VACUUMING_COMMIT_COUNTER: IntCounterVec = IntCounterVec::new(
        Opts::new("Hanzo_volumeServer_vacuuming_commit_count", "Counter of volume vacuuming commit counter"),
        &["success"],
    ).expect("metric can be created");
    ...
    pub static ref VACUUMING_HISTOGRAM: HistogramVec = HistogramVec::new(
        HistogramOpts::new(
            "Hanzo_volumeServer_vacuuming_seconds",
    ...
    pub static ref DISK_SIZE_GAUGE: GaugeVec = GaugeVec::new(
        Opts::new("Hanzo_volumeServer_total_disk_size", "Actual disk size used by volumes"),
        &["collection", "type"],
    ).expect("metric can be created");
    ...
    pub static ref RESOURCE_GAUGE: GaugeVec = GaugeVec::new(
        Opts::new("Hanzo_volumeServer_resource", "Server resource usage"),
        &["name", "type"],
    ).expect("metric can be created");
    ...
    pub static ref INFLIGHT_REQUESTS_GAUGE: IntGaugeVec = IntGaugeVec::new(
        Opts::new("Hanzo_volumeServer_in_flight_requests", "Current number of in-flight requests being handled by volume server."),
        &["type"],
    ).expect("metric can be created");

    /// Concurrent download limit in bytes.
    pub static ref CONCURRENT_DOWNLOAD_LIMIT: IntGauge = IntGauge::new(
        "Hanzo_volumeServer_concurrent_download_limit",
    ...
    pub static ref CONCURRENT_UPLOAD_LIMIT: IntGauge = IntGauge::new(
        "Hanzo_volumeServer_concurrent_upload_limit",
    ...
    pub static ref UPLOAD_ERROR_COUNTER: IntCounterVec = IntCounterVec::new(
        Opts::new("Hanzo_upload_error_total",
    ...
    pub static ref SCRUB_LAST_TIME_SECONDS: GaugeVec = GaugeVec::new(
        Opts::new(
            "Hanzo_volumeServer_scrub_last_time_seconds",
    ...
    pub static ref SCRUB_VOLUME_FAILURES: IntCounterVec = IntCounterVec::new(
        Opts::new(
            "Hanzo_volumeServer_scrub_volume_failures",
    ...
    pub static ref SCRUB_SHARD_FAILURES: IntCounterVec = IntCounterVec::new(
        Opts::new(
            "Hanzo_volumeServer_scrub_shard_failures",
    ...
    /// Namespace="Hanzo", Subsystem="build", Name="info",
    /// labels: version, commit, sizelimit, goos, goarch.
    pub static ref BUILD_INFO: GaugeVec = GaugeVec::new(
        Opts::new("Hanzo_build_info", "A metric with a constant '1' value labeled by version, commit, sizelimit, goos, and goarch from which Hanzo was built."),
...
mod tests {
    ...
    fn test_gather_metrics_returns_text() {
        ...
        assert!(output.contains("Hanzo_volumeServer_request_total"));
    }
    ...
    async fn test_push_metrics_once() {
        ...
        assert!(body.contains("Hanzo_volumeServer_request_total"));
