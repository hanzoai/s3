...
pub fn lookup_static_asset(path: &str) -> Option<EmbeddedAsset> {
    ...
    let asset = match path {
        "bootstrap/3.3.1/css/bootstrap.min.css" => EmbeddedAsset {
            ...
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/bootstrap/3.3.1/css/bootstrap.min.css"
            )),
        },
        "bootstrap/3.3.1/fonts/glyphicons-halflings-regular.eot" => EmbeddedAsset {
            ...
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/bootstrap/3.3.1/fonts/glyphicons-halflings-regular.eot"
            )),
        },
        "bootstrap/3.3.1/fonts/glyphicons-halflings-regular.svg" => EmbeddedAsset {
            ...
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/bootstrap/3.3.1/fonts/glyphicons-halflings-regular.svg"
            )),
        },
        "bootstrap/3.3.1/fonts/glyphicons-halflings-regular.ttf" => EmbeddedAsset {
            ...
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/bootstrap/3.3.1/fonts/glyphicons-halflings-regular.ttf"
            )),
        },
        "bootstrap/3.3.1/fonts/glyphicons-halflings-regular.woff" => EmbeddedAsset {
            ...
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/bootstrap/3.3.1/fonts/glyphicons-halflings-regular.woff"
            )),
        },
        ...
        "javascript/jquery-3.6.0.min.js" => EmbeddedAsset {
            ...
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/javascript/jquery-3.6.0.min.js"
            )),
        },
        "javascript/jquery-sparklines/2.1.2/jquery.sparkline.min.js" => EmbeddedAsset {
            ...
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/javascript/jquery-sparklines/2.1.2/jquery.sparkline.min.js"
            )),
        },
        "hanzo50x50.png" => EmbeddedAsset {
            content_type: "image/png",
            bytes: include_bytes!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../s3/static/hanzo50x50.png"
            )),
        },
        _ => return None,
    };
...
<html>
<head>
    <title>Hanzo {version}</title>
    <link rel="stylesheet" href="/hanzostatic/bootstrap/3.3.1/css/bootstrap.min.css">
    <script type="text/javascript" src="/hanzostatic/javascript/jquery-3.6.0.min.js"></script>
    <script type="text/javascript" src="/hanzostatic/javascript/jquery-sparklines/2.1.2/jquery.sparkline.min.js"></script>
...
<body>
    <div class="container">
        <div class="page-header">
            <h1>
                <a href="https://github.com/hanzoai/s3"><img src="/hanzostatic/hanzo50x50.png" alt="Hanzo"></a>
                Hanzo <small>{version}</small>
            </h1>
        </div>
