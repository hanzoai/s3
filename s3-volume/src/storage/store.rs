...
impl Store {
    ...
    pub fn add_location(
        ...
        // for the same vid (hanzo/hanzo#9478). Running before
    ...
    /// `s3/storage/store_ec.go`. The decoder needs per-shard paths
...
/// layout this helper is meant to prevent (hanzo/hanzo#9212).
///
...
///
/// Mirrors `ecFreeShardCount` in `s3/storage/store_ec.go`.
...
mod tests {
    ...
    /// Reproduces the placement half of hanzo/hanzo#9212. After
