...
func ReadEntry(masterClient *wdclient.MasterClient, filerClient filer_pb.HanzoFilerClient, dir, name string, byteBuffer *bytes.Buffer) error {
...
func ReadInsideFiler(ctx context.Context, filerClient filer_pb.HanzoFilerClient, dir, name string) (content []byte, err error) {
	request := &filer_pb.LookupDirectoryEntryRequest{
		Directory: dir,
		Name:      name,
	}
...
func SaveInsideFiler(ctx context.Context, client filer_pb.HanzoFilerClient, dir, name string, content []byte) error {
