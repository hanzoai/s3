...
func (ma *MetaAggregator) doSubscribeToOneFiler(f *Filer, self pb.ServerAddress, peer pb.ServerAddress, startFrom int64) (int64, error) {
	...
	*/
	...
	err = pb.WithFilerClient(true, 0, peer, ma.grpcDialOption, func(client filer_pb.HanzoFilerClient) error {
...
func (ma *MetaAggregator) traversePeerMetadata(f *Filer, peer pb.ServerAddress) error {
	return pb.WithFilerClient(true, 0, peer, ma.grpcDialOption, func(client filer_pb.HanzoFilerClient) error {
		ctx, cancel := context.WithCancel(context.Background())
		defer cancel()
...
func (ma *MetaAggregator) readFilerStoreSignature(peer pb.ServerAddress) (sig int32, err error) {
	err = pb.WithFilerClient(false, 0, peer, ma.grpcDialOption, func(client filer_pb.HanzoFilerClient) error {
...
// filerClient adapts a HanzoFilerClient to the FilerClient interface
...
func (fc filerClient) WithFilerClient(streamingMode bool, fn func(filer_pb.HanzoFilerClient) error) error {
	return fn(fc.client)
}
