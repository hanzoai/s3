...
func (store *LevelDB3Store) Initialize(configuration s3_util.Configuration, prefix string) (err error) {
...
func (store *LevelDB3Store) findDB(fullpath s3_util.FullPath, isForChildren bool) (*leveldb.DB, string, s3_util.FullPath, error) {
	...
	shortPath := s3_util.FullPath("/")
	if t > 0 {
		bucket = bucketAndObjectKey[:t]
		shortPath = s3_util.FullPath(bucketAndObjectKey[t:])
	}
...
func (store *LevelDB3Store) FindEntry(ctx context.Context, fullpath s3_util.FullPath) (entry *filer.Entry, err error) {
...
func (store *LevelDB3Store) DeleteEntry(ctx context.Context, fullpath s3_util.FullPath) (err error) {
...
func (store *LevelDB3Store) DeleteFolderChildren(ctx context.Context, fullpath s3_util.FullPath) (err error) {
...
func (store *LevelDB3Store) ListDirectoryEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
	return store.ListDirectoryPrefixedEntries(ctx, dirPath, startFileName, includeStartFile, limit, "", eachEntryFunc)
}

func (store *LevelDB3Store) ListDirectoryPrefixedEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, prefix string, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
