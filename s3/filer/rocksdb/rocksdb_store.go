...
func (store *RocksDBStore) Initialize(configuration s3_util.Configuration, prefix string) (err error) {
...
func (store *RocksDBStore) FindEntry(ctx context.Context, fullpath s3_util.FullPath) (entry *filer.Entry, err error) {
...
func (store *RocksDBStore) DeleteEntry(ctx context.Context, fullpath s3_util.FullPath) (err error) {
	dir, name := fullpath.DirAndName()
	key := genKey(dir, name)
...
func (store *RocksDBStore) DeleteFolderChildren(ctx context.Context, fullpath s3_util.FullPath) (err error) {
...
func (store *RocksDBStore) ListDirectoryEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
	return store.ListDirectoryPrefixedEntries(ctx, dirPath, startFileName, includeStartFile, limit, "", eachEntryFunc)
}

func (store *RocksDBStore) ListDirectoryPrefixedEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, prefix string, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
