...
func (store *TarantoolStore) Initialize(configuration s3_util.Configuration, prefix string) error {
...
func (store *TarantoolStore) FindEntry(ctx context.Context, fullpath s3_util.FullPath) (entry *filer.Entry, err error) {
	...
	err = entry.DecodeAttributesAndChunks(s3_util.MaybeDecompressData([]byte(row)))
	if err != nil {
...
func (store *TarantoolStore) DeleteEntry(ctx context.Context, fullpath s3_util.FullPath) (err error) {
	dir, name := fullpath.DirAndName()
...
func (store *TarantoolStore) DeleteFolderChildren(ctx context.Context, fullpath s3_util.FullPath) (err error) {
...
func (store *TarantoolStore) ListDirectoryPrefixedEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, prefix string, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
	return lastFileName, filer.ErrUnsupportedListDirectoryPrefixed
}

func (store *TarantoolStore) ListDirectoryEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
