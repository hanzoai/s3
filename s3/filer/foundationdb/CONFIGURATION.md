...
While not directly supported, configuration can be specified via config files passed to the `s3` command.
...
| Option | Type | Default | Description |
|--------|------|---------|-------------|
| `directory_prefix` | string | `hanzo` | Directory prefix for key organization |
...
enabled = true
cluster_file = "/etc/foundationdb/fdb.cluster"
directory_prefix = "hanzo_archive"
location = "/archive"
timeout = "300s"
max_retry_delay = "30s"
```
...
directory_prefix = "prod_hanzo"      # Production
directory_prefix = "staging_hanzo"   # Staging
directory_prefix = "dev_hanzo"       # Development

# Separate applications
directory_prefix = "app1_hanzo"      # Application 1
directory_prefix = "app2_hanzo"      # Application 2
```
...
sudo chown root:hanzo /etc/foundationdb/fdb.cluster
...
3. Migrate data using Hanzo tools
...
- Production: `prod_hanzo`
- Staging: `staging_hanzo` 
- Development: `dev_hanzo`
