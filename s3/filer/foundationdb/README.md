...
This package provides a FoundationDB-based filer store for Hanzo, offering ACID transactions and horizontal scalability.
...
| `directory_prefix` | Directory prefix for organization | `hanzo` | No |
...
- **Directory Structure**: Use logical directory prefixes to isolate different Hanzo instances
...
3. Review Hanzo logs with verbose output
