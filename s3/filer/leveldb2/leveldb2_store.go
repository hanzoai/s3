...
func (store *LevelDB2Store) Initialize(configuration s3_util.Configuration, prefix string) (err error) {
...
func (store *LevelDB2Store) FindEntry(ctx context.Context, fullpath s3_util.FullPath) (entry *filer.Entry, err error) {
...
func (store *LevelDB2Store) DeleteEntry(ctx context.Context, fullpath s3_util.FullPath) (err error) {
	dir, name := fullpath.DirAndName()
	key, partitionId := genKey(dir, name, store.dbCount)
...
func (store *LevelDB2Store) DeleteFolderChildren(ctx context.Context, fullpath s3_util.FullPath) (err error) {
...
func (store *LevelDB2Store) ListDirectoryEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
	return store.ListDirectoryPrefixedEntries(ctx, dirPath, startFileName, includeStartFile, limit, "", eachEntryFunc)
}

func (store *LevelDB2Store) ListDirectoryPrefixedEntries(ctx context.Context, dirPath s3_util.FullPath, startFileName string, includeStartFile bool, limit int64, prefix string, eachEntryFunc filer.ListEachEntryFunc) (lastFileName string, err error) {
...
func genDirectoryKeyPrefix(fullpath s3_util.FullPath, startFileName string, dbCount int) (keyPrefix []byte, partitionId int) {
