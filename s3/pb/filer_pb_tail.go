...
func makeSubscribeMetadataFunc(option *MetadataFollowOption, processEventFn ProcessMetadataFunc) func(client filer_pb.HanzoFilerClient) error {
	return func(client filer_pb.HanzoFilerClient) error {
