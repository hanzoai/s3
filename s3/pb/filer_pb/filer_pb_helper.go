...
func (entry *Entry) GetExpiryTime() (expiryTime int64) {
	...
	if entry.Extended != nil {
		if _, hasS3Expiry := entry.Extended[s3_constants.HanzoExpiresS3]; hasS3Expiry {
...
func CreateEntry(ctx context.Context, client HanzoFilerClient, request *CreateEntryRequest) error {
	_, err := CreateEntryWithResponse(ctx, client, request)
	return err
}

func CreateEntryWithResponse(ctx context.Context, client HanzoFilerClient, request *CreateEntryRequest) (*CreateEntryResponse, error) {
...
func UpdateEntry(ctx context.Context, client HanzoFilerClient, request *UpdateEntryRequest) error {
	_, err := UpdateEntryWithResponse(ctx, client, request)
	return err
}

func UpdateEntryWithResponse(ctx context.Context, client HanzoFilerClient, request *UpdateEntryRequest) (*UpdateEntryResponse, error) {
...
func LookupEntry(ctx context.Context, client HanzoFilerClient, request *LookupDirectoryEntryRequest) (*LookupDirectoryEntryResponse, error) {
