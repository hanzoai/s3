...
function exportBucketList() {
    ...
    a.href = url;
    a.download = `hanzo-buckets-${new Date().toISOString().split('T')[0]}.csv`;
...
function exportVolumeServers() {
    ...
    downloadCSV(csv, 'hanzo-volume-servers.csv');
}
...
function exportVolumes() {
    ...
    downloadCSV(csv, 'hanzo-volumes.csv');
}
...
function exportCollections() {
    ...
    // Download
    const filename = `hanzo-collections-${new Date().toISOString().split('T')[0]}.csv`;
...
function exportMasters() {
    ...
    // Download
    const filename = `hanzo-masters-${new Date().toISOString().split('T')[0]}.csv`;
    downloadCSV(csvContent, filename);
}
...
function exportFilers() {
    ...
    // Download
    const filename = `hanzo-filers-${new Date().toISOString().split('T')[0]}.csv`;
    downloadCSV(csvContent, filename);
}
...
function exportUsers() {
    ...
    downloadCSV(csvContent, 'hanzo-users.csv');
}
...
function exportFileList() {
    ...
    // Download
    const filename = `hanzo-files-${new Date().toISOString().split('T')[0]}.csv`;
    downloadCSV(csvContent, filename);
}
