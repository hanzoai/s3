...
func (p *TopicRetentionPurger) getTopicsWithRetention() ([]TopicRetentionConfig, error) {
	...
	err = p.adminServer.withBrokerClient(brokerLeader, func(client mq_pb.HanzoMessagingClient) error {
...
func (p *TopicRetentionPurger) purgeTopicData(topicRetention TopicRetentionConfig) error {
	...
	err := p.adminServer.WithFilerClient(func(client filer_pb.HanzoFilerClient) error {
...
func (p *TopicRetentionPurger) deleteDirectoryRecursively(client filer_pb.HanzoFilerClient, dirPath string) error {
