...
func (s *AdminServer) GetSubscribers() (*SubscribersData, error) {
	...
	// Note: HanzoMQ doesn't have a direct API to list all subscribers
...
func (s *AdminServer) findBrokerLeader() (string, error) {
	...
	for _, brokerAddr := range brokers {
		err := s.withBrokerClient(brokerAddr, func(client mq_pb.HanzoMessagingClient) error {
...
func (s *AdminServer) withBrokerClient(brokerAddress string, fn func(client mq_pb.HanzoMessagingClient) error) error {
