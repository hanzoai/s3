...
import (
	...
	clustermaintenance "github.com/hanzoai/s3/s3/cluster/maintenance"
	...
	"github.com/hanzoai/s3/s3/worker/tasks"

	_ "github.com/hanzoai/s3/s3/credential/grpc" // Register gRPC credential store
)
...
func (s *AdminServer) getFilerConfig() (*FilerConfig, error) {
	...
	err := s.WithFilerClient(func(client filer_pb.HanzoFilerClient) error {
...
func (m *masterVacuumToggler) disableVacuum() error {
	return m.server.WithMasterClient(func(client master_pb.HanzoClient) error {
...
func (s *AdminServer) enrichConfigDefaults(cfg *plugin_pb.PersistedJobTypeConfig) *plugin_pb.PersistedJobTypeConfig {
	...
	err := s.WithMasterClient(func(client master_pb.HanzoClient) error {
...
func (s *AdminServer) DeleteS3Bucket(bucketName string) error {
	...
	return s.WithFilerClient(func(client filer_pb.HanzoFilerClient) error {
...
func (s *AdminServer) CreateTopicWithRetention(namespace, name string, partitionCount int32, retentionEnabled bool, retentionSeconds int64) error {
	...
	err = s.withBrokerClient(brokerLeader, func(client mq_pb.HanzoMessagingClient) error {
		ctx, cancel := context.WithTimeout(context.Background(), 10*time.Second)
		defer cancel()
