...
import (
	...
	"github.com/hanzoai/s3/s3/admin/view/app"
	"github.com/hanzoai/s3/s3/admin/view/layout"
	"github.com/hanzoai/s3/s3/filer"
	"github.com/hanzoai/s3/s3/glog"
	"github.com/hanzoai/s3/s3/pb/filer_pb"
	"github.com/hanzoai/s3/s3/util"
	"github.com/hanzoai/s3/s3/util/http/client"
...
func (h *FileBrowserHandlers) DeleteFile(w http.ResponseWriter, r *http.Request) {
	...
	err := h.adminServer.WithFilerClient(func(client filer_pb.HanzoFilerClient) error {
...
// FullEntry stream — the format s3 shell fs.meta.load reads. Directories are
