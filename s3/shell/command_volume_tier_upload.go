...
func (c *commandVolumeTierUpload) Help() string {
	...
	Hanzo enables scalable and fast local access to lots of files, 
	...
	With this, Hanzo can be both fast and scalable, and infinite storage space.
	Just add more local Hanzo volume servers to increase the throughput.
...
func uploadDatToRemoteTier(grpcDialOption pb.DialOption, writer io.Writer, volumeId needle.VolumeId, collection string, sourceVolumeServer pb.ServerAddress, dest string, keepLocalDatFile bool) error {
