...
func TestSelectVolumeIdsFromTopology(t *testing.T) {
	...
	//       DataNode hanzo-volume-0.s3-volume.sea:8080 hdd(volume:14/15 active:14 free:1 remote:0)
	...
	//       DataNode hanzo-volume-0.s3-volume.sea:8080 {Size:4194776448 FileCount:518 DeletedFileCount:0 DeletedBytes:0}
	//   DataCenter DefaultDataCenter hdd(volume:28/30 active:28 free:2 remote:0)
	//     Rack DefaultRack hdd(volume:28/30 active:28 free:2 remote:0)
	//       DataNode hanzo-volume-1.s3-volume.sea:8080 hdd(volume:14/15 active:14 free:1 remote:0)
	//         Disk hdd(volume:14/15 active:14 free:1 remote:0) id:0
	...
	//           volume Id:14, Size:478153400, ReplicaPlacement:001, Collection:test, Version:3, Ttl:, FileCount:57, DeleteCount:0, DeletedByteCount:0, ReadOnly:false, ModifiedAtSecond:1770366020
	//         Disk hdd {Size:4194776448 FileCount:518 DeletedFileCount:0 DeletedBytes:0}
	//       DataNode hanzo-volume-1.s3-volume.sea:8080 {Size:4194776448 FileCount:518 DeletedFileCount:0 DeletedBytes:0}
				...
				RackInfos: []*master_pb.RackInfo{
					{
						...
						DataNodeInfos: []*master_pb.DataNodeInfo{
							{
								Id: "hanzo-volume-0.s3-volume.sea:8080",
							...
							{
								Id: "hanzo-volume-1.s3-volume.sea:8080",
								DiskInfos: map[string]*master_pb.DiskInfo{
									"hdd": {
										Type:            "hdd",
										FreeVolumeCount: 1,
