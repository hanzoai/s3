...
func (c *commandRemoteMountBuckets) Help() string {
	...
	s3 filer.remote.gateway -filer=<filerHost>:<filerPort> -createBucketAt=cloud1
...
func (c *commandRemoteMountBuckets) Do(args []string, commandEnv *CommandEnv, writer io.Writer) (err error) {
	...
	trimBucketSuffix := remoteMountBucketsCommand.Bool("trimBucketSuffix", true, "remote suffix auto generated by 's3 filer.remote.sync'")
