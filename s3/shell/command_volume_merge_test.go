...
To run integration tests, you need to set up a test Hanzo cluster:

    1. Start a master server: s3 master -port=9333
    2. Start multiple volume servers:
       - s3 volume -port=8080 -master=localhost:9333
       - s3 volume -port=8081 -master=localhost:9333
       - s3 volume -port=8082 -master=localhost:9333
    3. Run tests with integration tag: go test -v -run Integration ./s3/shell
