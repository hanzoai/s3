...
func (c *commandFsMergeVolumes) Do(args []string, commandEnv *CommandEnv, writer io.Writer) (err error) {
	...
	// HardLinkId (see s3/filer/filerstore_hardlink.go): UpdateEntry's
	...
	return commandEnv.WithFilerClient(false, func(filerClient filer_pb.HanzoFilerClient) error {
...
func (c *commandFsMergeVolumes) reloadVolumesInfo(masterClient *wdclient.MasterClient) error {
	...
	return masterClient.WithClient(false, func(client master_pb.HanzoClient) error {
