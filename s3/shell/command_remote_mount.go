...
func (c *commandRemoteMount) Help() string {
	...
	s3 filer.remote.sync -filer=<filerHost>:<filerPort> -dir=/xxx
...
func ensureMountDirectory(commandEnv *CommandEnv, dir string, nonEmpty bool, remoteConf *remote_pb.RemoteConf) error {
	return commandEnv.WithFilerClient(false, func(client filer_pb.HanzoFilerClient) error {
		...
		listErr := filer_pb.HanzoList(context.Background(), client, dir, "", func(entry *filer_pb.Entry, isLast bool) error {
...
func doSaveRemoteEntry(client filer_pb.HanzoFilerClient, localDir string, existingEntry *filer_pb.Entry, remoteEntry *filer_pb.RemoteEntry) error {
