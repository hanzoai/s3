...
// JSONSchemaDecoder handles JSON Schema validation and conversion to HanzoMQ format
...
// DecodeToRecordValue decodes JSON data directly to HanzoMQ RecordValue
...
// InferRecordType infers a HanzoMQ RecordType from the JSON Schema
...
// jsonSchemaToRecordType converts a JSON Schema to HanzoMQ RecordType
...
// jsonSchemaTypeToType converts a JSON Schema type to HanzoMQ Type
