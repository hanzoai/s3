...
// TestHanzoMQHandler wraps HanzoMQHandler for testing
type TestHanzoMQHandler struct {
	handler *HanzoMQHandler
	t       *testing.T
}

// NewTestHanzoMQHandler creates a new test handler with in-memory storage
func NewTestHanzoMQHandler(t *testing.T) *TestHanzoMQHandler {
	// For now, return a stub implementation
	// Full implementation will be added when needed
	return &TestHanzoMQHandler{
		handler: nil,
		t:       t,
	}
}
...
func (h *TestHanzoMQHandler) ProduceMessage(ctx context.Context, topic, partition string, record *schema_pb.RecordValue, key []byte) error {
...
func (h *TestHanzoMQHandler) CommitOffset(ctx context.Context, consumerGroup string, topic string, partition int32, offset int64, metadata string) error {
...
func (h *TestHanzoMQHandler) FetchOffset(ctx context.Context, consumerGroup string, topic string, partition int32) (int64, string, error) {
...
func (h *TestHanzoMQHandler) FetchMessages(ctx context.Context, topic string, partition int32, startOffset int64, maxBytes int32) ([]*Message, error) {
	// This will be implemented to use the handler's fetch logic
	return nil, fmt.Errorf("FetchMessages not yet implemented")
}

// Cleanup cleans up test resources
func (h *TestHanzoMQHandler) Cleanup() {
