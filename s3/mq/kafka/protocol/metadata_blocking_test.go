...
//
// NOTE: The actual fix is in the broker's ListTopics implementation (s3/mq/broker/broker_grpc_lookup.go)
...
func TestMetadataRequestBlocking(t *testing.T) {
	...
	handler := &Handler{
		hanzoMQHandler: &BlockingMockHandler{
	...
	case <-time.After(3 * time.Second):
		...
		t.Logf("  Root cause: hanzoMQHandler.ListTopics() blocks indefinitely when broker/filer is slow")
...
func TestMetadataRequestWithFastMock(t *testing.T) {
	...
	handler := &Handler{
		hanzoMQHandler: &FastMockHandler{
...
func TestMetadataRequestWithTimeoutFix(t *testing.T) {
	...
	handler := &Handler{
		hanzoMQHandler: &TimeoutAwareMockHandler{
...
func (h *FastMockHandler) WithFilerClient(streamingMode bool, fn func(client filer_pb.HanzoFilerClient) error) error {
	return fmt.Errorf("not implemented")
}
...
func (h *BlockingMockHandler) WithFilerClient(streamingMode bool, fn func(client filer_pb.HanzoFilerClient) error) error {
	return fmt.Errorf("not implemented")
}
...
func (h *TimeoutAwareMockHandler) WithFilerClient(streamingMode bool, fn func(client filer_pb.HanzoFilerClient) error) error {
	return fmt.Errorf("not implemented")
}
