...
func (b *MessageQueueBroker) WithFilerClient(streamingMode bool, fn func(filer_pb.HanzoFilerClient) error) error {
...
func (b *MessageQueueBroker) withBrokerClient(streamingMode bool, server pb.ServerAddress, fn func(client mq_pb.HanzoMessagingClient) error) error {

	return pb.WithBrokerGrpcClient(streamingMode, server.String(), b.grpcDialOption, func(client mq_pb.HanzoMessagingClient) error {
		return fn(client)
	})
