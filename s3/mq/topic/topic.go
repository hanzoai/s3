...
func (t Topic) ReadConfFile(client filer_pb.HanzoFilerClient) (*mq_pb.ConfigureTopicResponse, error) {
...
func (t Topic) ReadConfFileWithMetadata(client filer_pb.HanzoFilerClient) (*mq_pb.ConfigureTopicResponse, int64, int64, error) {
...
func (t Topic) WriteConfFile(client filer_pb.HanzoFilerClient, conf *mq_pb.ConfigureTopicResponse) error {
