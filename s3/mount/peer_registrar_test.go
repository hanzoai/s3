...
// filer_pb.HanzoFilerClient to drive the registrar.
...
func (f *fakeFilerFleet) dial(ctx context.Context, addr pb.ServerAddress, fn func(client filer_pb.HanzoFilerClient) error) error {
	c, ok := f.clients[addr]
	if !ok {
