...
func (a *buildFilerAccessor) WithFilerClient(_ bool, fn func(filer_pb.HanzoFilerClient) error) error {
	return fn(a.client)
}
...
// the local store directly (s3fs_file_mkrm.go createFile), off the metaCache
