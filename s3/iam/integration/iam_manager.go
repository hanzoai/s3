...
import (
	...
	"github.com/hanzoai/s3/s3/iam/oidc"
	"github.com/hanzoai/s3/s3/iam/policy"
	"github.com/hanzoai/s3/s3/iam/providers"
	"github.com/hanzoai/s3/s3/iam/sts"
	"github.com/hanzoai/s3/s3/iam/utils"
...
func (m *IAMManager) IsActionAllowed(ctx context.Context, request *ActionRequest) (bool, error) {
	...
	// We always try to validate with the internal STS service first if it's a Hanzo token.
