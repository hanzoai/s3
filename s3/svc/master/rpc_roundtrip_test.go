...
// streaming handler, returns a master client over a fresh dial conn, and a
// cleanup func.
...
// TestUnaryRoundTrip drives representative unary RPCs through the master
...
// master client: the client Sends AssignRequests and Recvs the matching
...
// the master client: each Heartbeat the client Sends is answered with a
