...
// filer.NewStreamServer.
//
// Opener handling — the ONE difference from filer.streamMutateAdapter: the
// master client (client.go) opens each bidi stream with an EMPTY opener frame
