...
func HasObjectsWithActiveLocks(ctx context.Context, client filer_pb.HanzoFilerClient, bucketPath string) (bool, error) {
	hasLocks := false
...
func paginateEntries(ctx context.Context, client filer_pb.HanzoFilerClient, dir string,
...
func recursivelyCheckLocksWithClient(ctx context.Context, client filer_pb.HanzoFilerClient, dir string, hasLocks *bool, currentTime time.Time) error {
	if *hasLocks {
...
func checkVersionsForLocksWithClient(ctx context.Context, client filer_pb.HanzoFilerClient, versionsDir string, hasLocks *bool, currentTime time.Time) error {
...
func CheckBucketForLockedObjects(ctx context.Context, client filer_pb.HanzoFilerClient, bucketsPath, bucketName string) error {
