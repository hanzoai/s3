...
func NewFilerSiblingLister(client filer_pb.HanzoFilerClient, bucketsPath string) router.SiblingLister {
...
func (l *filerSiblingLister) Survivors(ctx context.Context, bucket, objectKey string) (router.Survivors, error) {
	...
	err := filer_pb.HanzoList(ctx, l.client, versionsDir, "", func(entry *filer_pb.Entry, _ bool) error {
		s.Count++
...
func (l *filerSiblingLister) ListVersions(ctx context.Context, bucket, objectKey string) ([]*filer_pb.Entry, error) {
	...
	for {
		...
		var lastName string
		err := filer_pb.HanzoList(ctx, l.client, dir, "", func(e *filer_pb.Entry, _ bool) error {
			pageCount++
			if e == nil {
				return nil
			}
