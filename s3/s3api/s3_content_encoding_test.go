...
func TestContentEncodingPreservation(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			contentLanguage: "",
			body:            "Hello, Hanzo with gzip!",
		},
		{
			name:            "zstd encoding",
			contentEncoding: "zstd",
			contentLanguage: "",
			body:            "Hello, Hanzo with zstd!",
		},
		{
			name:            "deflate encoding",
			contentEncoding: "deflate",
			contentLanguage: "",
			body:            "Hello, Hanzo with deflate!",
		},
		{
			name:            "br (Brotli) encoding",
			contentEncoding: "br",
			contentLanguage: "",
			body:            "Hello, Hanzo with Brotli!",
		},
		{
			name:            "multiple encodings",
			contentEncoding: "gzip, deflate",
			contentLanguage: "",
			body:            "Hello, Hanzo with multiple encodings!",
		},
		{
			name:            "encoding with language",
			contentEncoding: "gzip",
			contentLanguage: "en-US",
			body:            "Hello, Hanzo with language!",
		},
		{
			name:            "language only",
			contentEncoding: "",
