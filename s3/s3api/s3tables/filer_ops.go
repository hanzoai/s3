...
func (h *S3TablesHandler) createDirectory(ctx context.Context, client filer_pb.HanzoFilerClient, path string) error {
...
func (h *S3TablesHandler) ensureDirectory(ctx context.Context, client filer_pb.HanzoFilerClient, path string) error {
	dir, name := splitPath(path)
...
func (h *S3TablesHandler) deleteEntryIfExists(ctx context.Context, client filer_pb.HanzoFilerClient, path string) error {
	dir, name := splitPath(path)
...
func (h *S3TablesHandler) setExtendedAttribute(ctx context.Context, client filer_pb.HanzoFilerClient, path, key string, data []byte) error {
	dir, name := splitPath(path)
...
func (h *S3TablesHandler) getExtendedAttribute(ctx context.Context, client filer_pb.HanzoFilerClient, path, key string) ([]byte, error) {
	dir, name := splitPath(path)
	resp, err := filer_pb.LookupEntry(ctx, client, &filer_pb.LookupDirectoryEntryRequest{
		Directory: dir,
		Name:      name,
...
func (h *S3TablesHandler) deleteExtendedAttribute(ctx context.Context, client filer_pb.HanzoFilerClient, path, key string) error {
	dir, name := splitPath(path)
...
func (h *S3TablesHandler) deleteDirectory(ctx context.Context, client filer_pb.HanzoFilerClient, path string) error {
	dir, name := splitPath(path)
...
func (h *S3TablesHandler) entryExists(ctx context.Context, client filer_pb.HanzoFilerClient, path string) bool {
	dir, name := splitPath(path)
	_, err := filer_pb.LookupEntry(ctx, client, &filer_pb.LookupDirectoryEntryRequest{
		Directory: dir,
		Name:      name,
