...
// ManagerClient adapts a HanzoFilerClient to the FilerClient interface.
type ManagerClient struct {
	client filer_pb.HanzoFilerClient
}

// NewManagerClient wraps a filer client.
func NewManagerClient(client filer_pb.HanzoFilerClient) *ManagerClient {
	return &ManagerClient{client: client}
}

// WithFilerClient implements FilerClient.
func (m *ManagerClient) WithFilerClient(streamingMode bool, fn func(client filer_pb.HanzoFilerClient) error) error {
	if m.client == nil {
