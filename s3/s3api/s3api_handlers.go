...
func (s3a *S3ApiServer) WithFilerClient(streamingMode bool, fn func(filer_pb.HanzoFilerClient) error) error {
...
func (s3a *S3ApiServer) withFilerClientFailover(preferred pb.ServerAddress, streamingMode bool, fn func(filer_pb.HanzoFilerClient) error) error {
