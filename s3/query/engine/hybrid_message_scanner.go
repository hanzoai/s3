...
import (
	...
	"github.com/hanzoai/s3/s3/mq/logstore"
...
// Uses Hanzo MQ's GenMergedReadFunc for seamless integration
// Assumptions:
...
func (hms *HybridMessageScanner) countLiveLogFiles(partition topic.Partition) (int, error) {
	...
	var fileCount int
	err := hms.filerClient.WithFilerClient(false, func(client filer_pb.HanzoFilerClient) error {
