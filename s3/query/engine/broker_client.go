...
// BrokerClient handles communication with Hanzo MQ broker
...
// 3. Topics and namespaces are managed via HanzoMessaging service
...
func (f *filerClientImpl) WithFilerClient(followRedirect bool, fn func(client filer_pb.HanzoFilerClient) error) error {
