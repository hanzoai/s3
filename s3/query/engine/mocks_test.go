...
// Does not attempt to connect to real Hanzo services
...
func (m *MockFilerClient) WithFilerClient(followRedirect bool, fn func(client filer_pb.HanzoFilerClient) error) error {
	if m.shouldFail {
