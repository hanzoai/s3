...
func (fs *FilerServer) SubscribeMetadata(req *filer_pb.SubscribeMetadataRequest, stream filer_pb.HanzoFiler_SubscribeMetadataServer) error {
...
func (fs *FilerServer) SubscribeLocalMetadata(req *filer_pb.SubscribeMetadataRequest, stream filer_pb.HanzoFiler_SubscribeLocalMetadataServer) error {
