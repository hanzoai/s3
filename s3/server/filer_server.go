...
import (
	...
	_ "github.com/hanzoai/s3/s3/filer/cassandra2"
	...
	"github.com/hanzoai/s3/s3/notification"
	_ "github.com/hanzoai/s3/s3/notification/aws_sqs"
	_ "github.com/hanzoai/s3/s3/notification/gocdk_pub_sub"
	_ "github.com/hanzoai/s3/s3/notification/google_pub_sub"
	_ "github.com/hanzoai/s3/s3/notification/kafka"
	_ "github.com/hanzoai/s3/s3/notification/log"
	_ "github.com/hanzoai/s3/s3/notification/webhook"
...
func (fs *FilerServer) checkWithMaster() {
	...
	for !isConnected {
		...
		for _, master := range fs.option.Masters.GetInstances() {
			readErr := operation.WithMasterServerClient(context.Background(), false, master, fs.grpcDialOption, func(masterClient master_pb.HanzoClient) error {
