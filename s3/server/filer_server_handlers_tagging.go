...
// add or replace one file Hanzo- prefixed attributes
// curl -X PUT -H "Hanzo-Name1: value1" http://localhost:8888/path/to/a/file?tagging
...
// remove all Hanzo- prefixed attributes
