...
func (c singleFilerClient) WithFilerClient(_ bool, fn func(filer_pb.HanzoFilerClient) error) error {
	return fn(c.client)
}
...
func listFilerEntries(ctx context.Context, client filer_pb.HanzoFilerClient, dir, prefix string) ([]*filer_pb.Entry, error) {
...
func walkFilerEntries(ctx context.Context, client filer_pb.HanzoFilerClient, dir string) ([]filerFileEntry, error) {
...
func loadCurrentMetadata(ctx context.Context, client filer_pb.HanzoFilerClient, bucketName, tablePath string) (table.Metadata, string, error) {
...
func loadFileByIcebergPath(ctx context.Context, client filer_pb.HanzoFilerClient, bucketName, tablePath, icebergPath string) ([]byte, error) {
...
func saveFilerFile(ctx context.Context, client filer_pb.HanzoFilerClient, dir, fileName string, content []byte) error {
...
func deleteFilerFile(ctx context.Context, client filer_pb.HanzoFilerClient, dir, fileName string) error {
...
func updateTableMetadataXattr(ctx context.Context, client filer_pb.HanzoFilerClient, tableDir string, expectedVersion int, newFullMetadata []byte, newMetadataLocation string) error {
