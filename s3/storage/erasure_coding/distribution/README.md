...
- **Reusable**: Used by shell commands, worker tasks, and hanzo-enterprise
...
### Custom EC Ratios (hanzo-enterprise)
...
```go
import "github.com/hanzoai/s3/s3/shell"
...
```go
import "github.com/hanzoai/s3/s3/storage/erasure_coding/distribution"
