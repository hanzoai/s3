...
func TestParseUploadUsesDiscoveredFilePartContentType(t *testing.T) {
	...
	fileHeader.Set("Content-Type", "application/x-hanzo-test")
	...
	if pu.MimeType != "application/x-hanzo-test" {
		t.Fatalf("MimeType = %q, want application/x-hanzo-test", pu.MimeType)
	}
}
