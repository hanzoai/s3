...
/*
makediff test steps
1. launch s3 server at your local/dev environment, (option
...
preparing test prerequisite easier )
   a) ./s3 master -garbageThreshold=0.99 -mdir=./m
   b) ./s3 volume -dir=./data -max=1 -master=localhost:9333 -port=8080
