...
func init() {
	...
	hanzokms.RegisterProvider("vault", NewOpenBaoKMSProvider) // Alias for compatibility
}
...
func NewOpenBaoKMSProvider(config util.Configuration) (hanzokms.KMSProvider, error) {
	if config == nil {
...
func (p *OpenBaoKMSProvider) GenerateDataKey(ctx context.Context, req *hanzokms.GenerateDataKeyRequest) (*hanzokms.GenerateDataKeyResponse, error) {
	if req == nil {
	...
	envelopeBlob, err := hanzokms.CreateEnvelope("openbao", req.KeyID, ciphertext, nil)
	if err != nil {
...
func (p *OpenBaoKMSProvider) Decrypt(ctx context.Context, req *hanzokms.DecryptRequest) (*hanzokms.DecryptResponse, error) {
	if req == nil {
...
func (p *OpenBaoKMSProvider) DescribeKey(ctx context.Context, req *hanzokms.DescribeKeyRequest) (*hanzokms.DescribeKeyResponse, error) {
	if req == nil {
	...
	response.Origin = hanzokms.KeyOriginOpenBao
