...
func init() {
	...
	hanzokms.RegisterProvider("azure", NewAzureKMSProvider)
}
...
func NewAzureKMSProvider(config util.Configuration) (hanzokms.KMSProvider, error) {
	if config == nil {
...
func (p *AzureKMSProvider) GenerateDataKey(ctx context.Context, req *hanzokms.GenerateDataKeyRequest) (*hanzokms.GenerateDataKeyResponse, error) {
	if req == nil {
	...
	envelopeBlob, err := hanzokms.CreateEnvelope("azure", actualKeyID, string(encryptResult.Result), nil)
	if err != nil {
...
func (p *AzureKMSProvider) Decrypt(ctx context.Context, req *hanzokms.DecryptRequest) (*hanzokms.DecryptResponse, error) {
	if req == nil {
...
func (p *AzureKMSProvider) DescribeKey(ctx context.Context, req *hanzokms.DescribeKeyRequest) (*hanzokms.DescribeKeyResponse, error) {
	if req == nil {
	...
	response.Origin = hanzokms.KeyOriginAzure
