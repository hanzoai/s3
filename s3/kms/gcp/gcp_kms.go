...
func init() {
	...
	hanzokms.RegisterProvider("gcp", NewGCPKMSProvider)
}
...
func NewGCPKMSProvider(config util.Configuration) (hanzokms.KMSProvider, error) {
	if config == nil {
...
func (p *GCPKMSProvider) GenerateDataKey(ctx context.Context, req *hanzokms.GenerateDataKeyRequest) (*hanzokms.GenerateDataKeyResponse, error) {
	if req == nil {
	...
	envelopeBlob, err := hanzokms.CreateEnvelope("gcp", encryptResp.Name, string(encryptResp.Ciphertext), nil)
	if err != nil {
...
func (p *GCPKMSProvider) Decrypt(ctx context.Context, req *hanzokms.DecryptRequest) (*hanzokms.DecryptResponse, error) {
	if req == nil {
...
func (p *GCPKMSProvider) DescribeKey(ctx context.Context, req *hanzokms.DescribeKeyRequest) (*hanzokms.DescribeKeyResponse, error) {
	if req == nil {
	...
	response.Origin = hanzokms.KeyOriginGCP
