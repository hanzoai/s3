...
func (lock *LiveLock) StopShortLivedLock() error {
	...
	return pb.WithFilerClient(false, 0, lock.hostFiler, lock.grpcDialOption, func(client filer_pb.HanzoFilerClient) error {
...
func (lock *LiveLock) doLock(lockDuration time.Duration) (errorMessage string, err error) {
	...
	err = pb.WithFilerClient(false, 0, lock.hostFiler, lock.grpcDialOption, func(client filer_pb.HanzoFilerClient) error {
