...
func (fca *FilerClientAccessor) WithFilerClient(streamingMode bool, fn func(filer_pb.HanzoFilerClient) error) error {
	return fca.withMultipleFilers(streamingMode, fn)
}

// withMultipleFilers tries each filer with smart failover and backoff logic
func (fca *FilerClientAccessor) withMultipleFilers(streamingMode bool, fn func(filer_pb.HanzoFilerClient) error) error {
...
func (fca *FilerClientAccessor) SaveTopicConfToFiler(t topic.Topic, conf *mq_pb.ConfigureTopicResponse) error {
	...
	return fca.WithFilerClient(false, func(client filer_pb.HanzoFilerClient) error {
...
func (fca *FilerClientAccessor) ReadTopicConfFromFiler(t topic.Topic) (conf *mq_pb.ConfigureTopicResponse, err error) {
	...
	if err = fca.WithFilerClient(false, func(client filer_pb.HanzoFilerClient) error {
