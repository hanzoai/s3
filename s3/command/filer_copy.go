...
func (worker *FileCopyWorker) checkExistingFileFirst(task FileCopyTask, f *os.File) (shouldCopy bool, err error) {
	...
	err = pb.WithGrpcFilerClient(false, worker.signature, worker.filerAddress, worker.options.grpcDialOption, func(client filer_pb.HanzoFilerClient) error {
...
func (worker *FileCopyWorker) uploadFileAsOne(task FileCopyTask, f *os.File) error {
	...
	if err := pb.WithGrpcFilerClient(false, worker.signature, worker.filerAddress, worker.options.grpcDialOption, func(client filer_pb.HanzoFilerClient) error {
