...
type MountOptions struct {
	...
	// Peer chunk sharing options (design-s3-mount-peer-chunk-sharing.md).
	peerEnabled      *bool
	peerListen       *string
...
func init() {
	...
	mountOptions.filer = cmdMount.Flag.String("filer", "localhost:8888", "comma-separated s3 filer location")
	mountOptions.filerMountRootPath = cmdMount.Flag.String("filer.path", "/", "mount this remote path from filer server")
	mountOptions.dir = cmdMount.Flag.String("dir", ".", "mount s3 filer to this directory")
	...
	mountOptions.localSocket = cmdMount.Flag.String("localSocket", "", "default to /tmp/hanzo-mount-<mount_dir_hash>.sock")
...
var cmdMount = &Command{
	...
	Short:     "mount s3 filer to a directory as file system in userspace(FUSE)",
	Long: `mount s3 filer to userspace.
  ...
  For ultra-fast reads, enable RDMA acceleration with an RDMA sidecar:
    s3 mount -filer=localhost:8888 -dir=/mnt/hanzo \
