...
func (option *RemoteSyncOptions) WithFilerClient(streamingMode bool, fn func(filer_pb.HanzoFilerClient) error) error {
...
func init() {
	...
	remoteSyncOptions.filerAddress = cmdFilerRemoteSynchronize.Flag.String("filer", "localhost:8888", "filer of the Hanzo S3 cluster")
...
var cmdFilerRemoteSynchronize = &Command{
	...
	and write to the remote storage.
		...
		s3 filer.remote.sync -dir=/mount/s3_on_cloud
